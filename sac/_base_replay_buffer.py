# Replay buffer for TD3-like off-policy algorithms
# The basebuffer is directly borrowed & decoupled from StableBaselines3
...
class BaseBuffer(ABC):
    ...
    def to_th(self, array: np.ndarray, copy: bool = True) -> th.Tensor:
        """
        Convert a numpy array to a Pyth tensor.
...
class ReplayBuffer(BaseBuffer):
    ...
    def _get_samples(self, batch_inds: np.ndarray, env = None) -> ReplayBufferSamples:
        ...
        return ReplayBufferSamples(*tuple(map(self.to_th, data)))